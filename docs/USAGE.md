...
The mod includes an in-game UI configuration system for easy settings management. For detailed information, see:
- **Quick Start**: [docs/UI_QUICK_START.md](./docs/UI_QUICK_START.md)
- **Full Documentation**: [docs/CONFIGURATION_UI.md](./docs/CONFIGURATION_UI.md)

### Quick Configuration Access

```csharp
using ONIMod.Configuration;

// Access configuration
var options = NeuroModOptions.Instance;
string wsUrl = options.WebSocketUrl;
...
For manual configuration, edit `mod_config.yaml` in your mod folder.
